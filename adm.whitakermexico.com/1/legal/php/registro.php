...
$query = "INSERT INTO tb_clientes (ID, c_razonsocial, c_rfc, c_regimen, c_calle, c_nexterior, c_ninterior, c_cp, c_estatus) 
VALUES 
('$espacio', '$cliente', '$rfc', '$regimen', '$calle', '$nexterior', '$ninterior', '$cp', '$estatus')";

// Consulta para verificar que el cliente no existe en la BD clientes...

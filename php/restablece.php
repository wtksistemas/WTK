...
try {
    ...
    $mail->Body  = '<br> Usa el siguiente codigo de verificacion: <br> '.$tkn2.'<p> Para restablecer tu cuenta entra al siguiente <a href="http://localhost:3000/adm.whitakermexico.com/generacion.php?tkn='.$tkn.'"> enlace </a> <br>

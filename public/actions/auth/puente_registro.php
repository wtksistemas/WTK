<?php
/**
 * PUENTE PÚBLICO: Procesar Registro
 * Ubicación: WTK/public/actions/auth/puente_registro.php
 */
...
if (empty($_POST['nombre']) || empty($_POST['apellido']) || empty($_POST['rfc']) || empty($_POST['email']) || empty($_POST['fon']) || empty($_POST['password']) || empty($_POST['cfpassword'])) {
...
require_once __DIR__ . '/../../../src/auth/registro_process.php';
?>